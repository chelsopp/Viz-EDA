...
This is still a dataframe note: `group_by(name, month)` = there are 24
months and 3 names and each distinct combination of those will be a
group
...
what about lags? note: showing you observations from previous entry
